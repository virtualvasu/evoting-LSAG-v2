...
} from "../../LSAGVotingSystemTest.sol/IRegistrationContract";
...
const _abi = [
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "bytes32",
        name: "_randomChallenge",
        type: "bytes32",
      },
    ],
    name: "storePollParams",
    outputs: [
      {
        internalType: "bool",
        name: "",
    ...
    inputs: [
      {
        components: [
          {
            internalType: "bytes",
            name: "governmentSignature",
            type: "bytes",
          },
          {
            internalType: "bytes",
            name: "governmentPublicKey",
            type: "bytes",
          },
          {
            internalType: "bytes",
        ...
        internalType: "struct IRegistrationContract.Certificate",
        name: "cert",
        type: "tuple",
      },
    ],
